...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="width:103px;height:67px;top:66px;left:868px;"> 
     <div component="$UI/system/components/justep/reportData/reportData" xid="s1"> 
      <source xid="default1"> 
        <action id="default6" columns="NONUM,SEXECUTORPERSONNAME,SEXECUTORDEPTNAME,SPROCESSNAME,TASKNUM,TOTLETIME,LONGTIME" name="personLimitRankAction" type="action" /> 
      </source> 
    </div><div component="$UI/system/components/justep/data/data" xid="itemData"
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="masterData" idColumn="startDate"> 
  ...
  <div component="$UI/system/components/bootstrap/tabs/tabs" xid="tabs"> 
    <div class="tab-content" xid="div1"> 
      <div class="tab-pane active" xid="tabContent1"> 
        ...
        <div component="$UI/system/components/justep/report/report" src="personlimit_xls.xml"
