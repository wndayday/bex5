...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:334px;top:318px;"> 
    <div component="$UI/system/components/justep/data/bizData" xid="mainData"
      directDelete="true" autoLoad="true" concept="SA_OPManageType" onSaveCommit="saveCommit"
      limit="20"> 
      <reader action="/SA/OPM/logic/action/queryOPManageTypeAction"/>  
      <writer action="/SA/OPM/logic/action/saveOPManageTypeAction"/>  
      <creator action="/SA/OPM/logic/action/createOPManageTypeAction"/>  
      <calculateRelation relation="calcIsSystemLabel" xid="calculateRelation1"/>  
      <rule xid="rule1">
   <col name="sName" xid="ruleCol2">
    <readonly xid="readonly2">
     <expr xid="default7">$row.val(&quot;sIsSystem&quot;) == 1</expr></readonly> 
    <required xid="required1">
     <expr xid="default6">true</expr>
     <message xid="default9">名称不能为空</message></required> </col> 
   <col name="sCode" xid="ruleCol3">
    <readonly xid="readonly3">
     <expr xid="default8">$row.val(&quot;sIsSystem&quot;) == 1</expr></readonly> 
    <required xid="required2">
     <expr xid="default10">true</expr>
     <message xid="default11">编码不能为空</message></required> </col> 
   <col name="calcIsSystemLabel" xid="ruleCol1">
    <calculate xid="calculate1">
     <expr xid="default1">$row.val(&quot;sIsSystem&quot;) == 1 ? '是' : '否'</expr></calculate> </col> </rule></div> 
  </div>  
  <div xid="view"> 
    <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"
      ...
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
        label="删除" xid="deleteBtn" onClick="{&quot;operation&quot;:&quot;mainData.delete&quot;}" bind-disable=" $model.mainData.val(&quot;sIsSystem&quot;) == 1"> 
        <i xid="i4"/>  
    ...
    <div component="$UI/system/components/justep/grid/grid" xid="mainGrid"
      ...
      <columns xid="column"> 
        ...
        <column width="100" name="calcIsSystemLabel" xid="column1" label="系统"/>
      </columns> 
    </div> 
  </div>  
