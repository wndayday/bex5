...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window takeout" component="$UI/system/components/justep/window/window"
  design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:106px;left:273px;"
    onLoad="modelLoad"> 
    ...
    <div component="$UI/system/components/justep/data/baasData" autoLoad="false"
      xid="userData" idColumn="fID" autoNew="false" queryAction="queryUser" tableName="takeout_user"
      url="/justep/takeout" saveAction="save"> 
      ...
      <filter name="userFilter" xid="filter1"><![CDATA[fID = :user]]></filter>
    </div>  
    <div component="$UI/system/components/justep/data/baasData" autoLoad="false"
      orderBy="fCreateTime:desc" xid="orderData" idColumn="fID" confirmRefresh="false"
      confirmDelete="false" queryAction="queryOrder" tableName="takeout_order" url="/justep/takeout"
      limit="10" saveAction="save" onSaveCreateParam="orderDataSaveCreateParam"> 
      ...
      <filter name="userFilter" xid="filter2"><![CDATA[fUserID = :user]]></filter>  
      <filter name="filter0" xid="filter3"/>
    </div>  
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <data xid="default36">[{"fID":"1","fPayType":"weixin","fPayTypeLabel":"微信支付"},{"fID":"2","fPayType":"alipay","fPayTypeLabel":"支付宝支付"},{"fID":"3","fPayType":"weixinJSSDK","fPayTypeLabel":"微信内支付"},{"fID":"4","fPayType":"faceToFace","fPayTypeLabel":"货到付款"},{"fID":"5","fPayType":"union","fPayTypeLabel":"银联支付"}]</data>
    </div> 
  </div>  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
      ...
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-left" xid="div1"> 
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon"
            style="display:none" label="" xid="backBtn" icon="icon-chevron-left" onClick="{&quot;operation&quot;:&quot;window.close&quot;}"
    ...
    <div class="x-panel-content" xid="content1"> 
      <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
        ...
        <div class="x-contents-content x-cards" xid="cartContent" onActive="cartContentActive"> 
                  ...
                  <div class="col-xs-9" xid="col1"> 
                    <div class="input-group" component="$UI/system/components/bootstrap/inputGroup/inputGroup"
                      ...
                      <input type="text" class="form-control" component="$UI/system/components/justep/input/input"
                        xid="input4" bind-ref='$model.userData.ref("fAddress")'/>  
                      <div class="input-group-btn" xid="div7"> 
                        <a component="$UI/system/components/justep/button/button"
                          class="btn btn-link" label=" 定位" xid="button1" onClick="locationClick"
                          icon="icon-android-location"> 
                          <i xid="i15" class="icon-android-location"/>  
                          <span xid="span20">定位</span>
                        </a> 
                      </div> 
                    </div> 
                  </div> 
        ...
        <div class="x-contents-content x-content-on-right" xid="orderContent"> 
          <div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView"
            xid="scrollView1"> 
        ...
        <div class="x-contents-content x-cards" xid="ownContent" onActive="ownContentActive"> 
            ...
            <div class="modal-body"> 
              <form class="form-horizontal"> 
                ...
                <div class="form-group"> 
                  ...
                  <div class="col-xs-9"> 
                    <input type="text" class="form-control x-edit" component="$UI/system/components/justep/input/input"
                      xid="input5" bind-ref="$model.userData.ref(&quot;fAddress&quot;)"/>
                  </div> 
                </div> 
              </form> 
            </div>  
...
<span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog1" src="$UI/takeout/mapActivity.w"></span></div>
