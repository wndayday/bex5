...
<h4 xid="h41"><![CDATA[分组表格(宽度自适应)]]>
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="source" onClick="sourceClick">
   <i xid="i2"></i>
   <span xid="span2">源码</span></a></h4><div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true" altRows="true" class="x-grid-no-bordered" xid="employeeGrid" data="employeeData" showRowNumber="true" width="100%" useGroupbar="true" grouping="true" height="auto" useFooter="false">
   <columns xid="columns1"><column name="name" xid="column1"><group xid="default11" columnShow="true"></group></column>
  <column name="sex" xid="column2" editor="component" editable="true"><group xid="default10" columnShow="false" summary="false" text="{0}"></group></column>
