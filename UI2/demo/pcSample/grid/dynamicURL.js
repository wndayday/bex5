define(function(require) {
	...
	//点击按钮
	Model.prototype.dynamicSetClick = function(event) {
		this.comp('employeeData').refreshData();
	};
	//加载数据
	...
	Model.prototype.jsClick = function(event) {
		util.showSource({
			self : this,
			data : "demo/pcSample/grid/dynamicURL.js"
		},true);
	};
	//源码
	Model.prototype.sourceClick = function(event) {
		util.showSource({
			self : this,
			type : true,
			data : "demo/pcSample/grid/dynamicURL.w&xid=employeeGrid"
		},true);
	};
