...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:68px;top:397px;"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <data xid="default1">[{"type":"全部","property":"正片","age":"全部"},{"type":"战斗","property":"连载","age":"6岁以下"},{"type":"热血","property":"完结","age":"6-12岁"},{"type":"冒险励志","property":"短片","age":"12-18岁"},{"type":" 英雄","age":"18岁以上"},{"type":" 后宫 "},{"type":"耽美"},{"type":" 魔法"},{"type":" 奇幻"},{"type":" 搞笑"},{"type":" 恋爱"},{"type":" 校园 "},{"type":"宠物"},{"type":" 日常 "},{"type":"童话"},{"type":" 惊悚"},{"type":"竞技"},{"type":"都市"},{"type":"动作"},{"type":"科幻"}]</data>
    </div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="numData" idColumn="fID" confirmRefresh="false"> 
  ...
  <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
    ...
    <div class="x-contents-content" xid="content1"> 
      <h4 xid="h41"><![CDATA[鼠标移入展开(多选)]]>
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="js" xid="jsBtn" onClick="jsBtnClick">
   <i xid="i2"></i>
   <span xid="span3">js</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="sourceBtn" onClick="sourceClick">
   <i xid="i3"></i>
   <span xid="span4">源码</span></a>
  </h4><div component="$UI/system/components/justep/controlGroup/controlGroup"
        class="x-control-group " xid="controlGroup1" style="height:51px;"> 
        ...
        <div xid="div2" class="mgr pull-left"> 
          ...
          <div xid="div3" style="position:absolute;z-index:inherit;"> 
        ...
        <div xid="div1" style="border-style:ridge ridge ridge ridge;border-width:2px 2px 2px 2px;width:80%;left:200px;top:60px;height:auto;position:absolute;"> 
          <div component="$UI/system/components/justep/row/row" class="x-row"
            xid="row1" style="border-style:ridge ridge ridge ridge;border-width:2px 2px 2px 2px;"> 
            <label xid="label1" style="width:87px;height:30px;left:10px;position:relative;top:5px;"
              class="labe"><![CDATA[筛选条件:]]></label>  
            <div component="$UI/system/components/justep/list/list" class="x-list"
