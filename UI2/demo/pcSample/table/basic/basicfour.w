...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <h4 xid="h41"><![CDATA[列表-radio模式]]>  
    <a component="$UI/system/components/justep/button/button" class="btn btn-link"
      label="获取选中项" xid="button1" onClick="buttonOneClick"> 
      <i xid="i3"/>  
      <span xid="span3">获取选中项</span>
    </a>
    <a component="$UI/system/components/justep/button/button" class="btn btn-link"
  ...
  <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true"
    ...
    showRowNumber="false" multiSelect="false" onRowClick="dataTablesRowClick" onCellRender="dataTablesCellRender"> 
    <columns xid="columns1"> 
      <column name="inventory" xid="column4" label="" width="40" className="x-dt-cell-center"
        orderable="false" searchable="false" visible="true"/>  
