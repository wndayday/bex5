...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <h4 xid="h41"><![CDATA[列表-checkbox模式]]>  
    <a component="$UI/system/components/justep/button/button" class="btn btn-link"
      label="获取选中项" xid="button" onClick="buttonOneClick"> 
      <i xid="i1"/>  
      <span xid="span1">获取选中项</span> 
    </a>  
    <a component="$UI/system/components/justep/button/button" class="btn btn-link"
  ...
  <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true"
    ...
    showRowNumber="false" multiSelect="true" onRowCheck="dataTablesRowCheck" onRowCheckedAll="dataTablesRowCheckedAll"> 
