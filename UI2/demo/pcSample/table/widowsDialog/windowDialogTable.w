...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group"
    ...
    <div class="form-group" xid="formGroup1"> 
      <div class="col-sm-2" xid="col13" style="width:auto;"> 
      ...
      <div class="col-sm-2" xid="col1" style="width:auto;"> 
        <label class="control-label pull-right" xid="controlLabel2"><![CDATA[关键词：]]></label> 
      </div>  
        ...
        <div class="input-group" xid="div5"> 
          ...
          <span class="input-group-btn" xid="span1"> 
            <a component="$UI/system/components/justep/button/button" class="btn btn-default"
              icon="icon-android-search" xid="button1"> 
  ...
  <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true"
    rowActiveClass="active" xid="dataTables" data="tableData" responsive="false" class="table table-hover table-striped"> 
    <columns xid="columns"> 
      <column name="tName" xid="column9" orderable="false" width="70"/>  
      <column name="tSex" xid="column10" orderable="false" width="50"/>  
      <column name="tAge" xid="column11" orderable="false" width="50"/>  
      <column name="tJob" xid="column12" orderable="false" width="150"/>  
      <column name="tPhone" xid="column13" orderable="false" width="150"/>  
      <column name="tAddress" xid="column14" orderable="false" width="200"/>  
