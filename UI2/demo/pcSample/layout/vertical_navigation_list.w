...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:pc">  
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="源码" xid="sourceBtn" onClick="sourceBtnClick">
   <i xid="i7"></i>
   <span xid="span9">源码</span></a></h4><div component="$UI/system/components/justep/row/row" class="x-row" xid="row1" style="height:100%;">
   <div class="x-col x-col-fixed" xid="col1" style="width:auto;height:100%;"><div xid="menu" style="height:100%;overflow:hidden;width:200px;" class="div1">
   <div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group" xid="controlGroup1" style="height:100%;width:90%;" title="一级栏目1">
    <div class="x-control-group-title" xid="controlGroupTitle1" style="background-color:#599FD2;">
     <span xid="span1">一级栏目1</span></div> 
    ...
    <a component="$UI/system/components/justep/button/button" class="btn1 btn btn-link" label="二级栏目3" xid="select3" style="width:80%;" onClick="selectThreeClick" bind-css="{'cli' : $model.statusData.val(&quot;edit&quot;) == 3}" target="content3">
     <i xid="i3"></i>
    ...
    <a component="$UI/system/components/justep/button/button" class="btn1 btn btn-link" label="二级栏目5" xid="select5" style="width:80%;" onClick="selectFiveClick" bind-css="{'cli' : $model.statusData.val(&quot;edit&quot;) == 5}" target="content5">
     <i xid="i5"></i>
     <span xid="span6">二级栏目5</span></a> 
    </div> 
  </div>
  </div>
   <div class="x-col" xid="col3" style="height:100%;"><div xid="page" style="height:100%;width:100%;"><div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group pull-right" title="内容部分" xid="controlGroup2" style="width:100%;height:100%;">
   <div class="x-control-group-title" xid="controlGroupTitle2" style="background-color:#47A2D1;height:56px;">
  ...
  <div component="$UI/system/components/justep/contents/contents" class="x-contents" active="0" xid="contents1" style="width:100%;white-space:nowrap;overflow-y:scroll;height:88%;">
   <div class="x-contents-content" xid="content1" style="height:100%;"><div xid="div3" style="height:160px;width:100px;"><label xid="label1"><![CDATA[一级栏目1]]></label>
  </div>
  ...
  <div xid="div24" style="height:160px;width:100px;">
   <label xid="label23"><![CDATA[一级栏目5]]></label></div></div></div></div></div></div></div>
  </div>