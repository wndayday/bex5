...
<div component="$UI/system/components/justep/popOver/popOver" class="x-popOver" xid="popOver1" opacity="0.5" dismissible="false">
  ...
  <i xid="i2"></i></div></div></div>
   <div class="x-panel-content" xid="content1"><div xid="div7" class="list-group-item" style="background-color:#E3E3E3;"><div xid="div1" class="has-feedback"><div xid="div6"><span xid="span11" class="form-control-feedback icon-android-search"></span><input component="$UI/system/components/justep/input/input" class="form-control" xid="search"></input></div></div></div><div xid="div2"><ul xid="ul1">
    <li class="list-group-item" xid="li101">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-xs btn-only-icon pull-right" label="button" xid="button12" icon="icon-ios7-arrow-right">
      <i xid="i18" class="icon-ios7-arrow-right text-muted"></i>
      <span xid="span17"></span></a> 
     <span xid="span16"><![CDATA[热门搜索]]></span></li> 
    <li class="list-group-item" xid="li201">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-xs btn-only-icon pull-right" label="button" xid="button14" icon="icon-ios7-arrow-right">
      <i xid="i27" class="icon-ios7-arrow-right text-muted"></i>
      <span xid="span20"></span></a> 
     <span xid="span19"><![CDATA[最近搜索]]></span></li> 
    <li class="list-group-item" xid="li301">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-xs btn-only-icon pull-right" label="button" xid="button160" icon="icon-ios7-arrow-right">
      <i xid="i290" class="icon-ios7-arrow-right text-muted"></i>
      <span xid="span230"></span></a> 
     <span xid="span220"><![CDATA[最近浏览]]></span></li>
     <li class="list-group-item" xid="li1">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-xs btn-only-icon pull-right" label="button" xid="button16" icon="icon-ios7-arrow-right">
    ...
    <li class="list-group-item" xid="li4">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-xs btn-only-icon pull-right" xid="button2" icon="icon-ios7-arrow-right">
      <i xid="i3" class="icon-ios7-arrow-right text-muted"></i>
      <span xid="span4"></span></a> 
     <span xid="span3"><![CDATA[摇一摇]]></span></li> </ul></div>
  <div xid="div3" style="background-color:#E3E3E3;height:40px;display:none;"></div>
  
  <div xid="div5" align="center" class="panel-body">
  </div>
  <a component="$UI/system/components/justep/button/button" class="btn x-orange btn-block" label="按住说话" xid="saying" bind-touchstart="sayingTouchstart" bind-touchend="sayingTouchend" style="margin-top:30px;">
   ...
   <div class="x-col text-muted" xid="col1"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-xs btn-icon-top" label="书架" xid="button4" icon="icon-android-book">
