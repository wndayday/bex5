...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window oa" class="window oa" component="$UI/system/components/justep/window/window" design="device:m;">  
        ...
        <div class="x-panel-bottom device-bottom" xid="bottom1" height="100"> 
          <div xid="content" style="padding:10px 10px 10px 10px;"> 
            <div id="titleDiv" xid="titleDiv">
              <label xid="operateLabel"><![CDATA[]]></label>
            </div>  
            <div id="fileDiv" xid="fileDiv">
              <label xid="resultLabel" ><![CDATA[]]></label>
            </div> 
          </div> 
        </div> 
      </div> 
