...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="searchData"> 
    <div component="$UI/system/components/justep/reportData/reportData" xid="ds1"> 
      <source xid="default1"> 
        <action name="ksqlReportAction" type="ksqlaction"/> 
      </source> 
    </div> 
  </div>  
  <div component="$UI/system/components/bootstrap/tabs/tabs" xid="tabs"> 
    <ul class="nav nav-tabs" xid="tabNav1"> 
      <li class="active" xid="li1"> 
        <a content="tabContent1" xid="tabItem1">ksql数据查询报表</a> 
      </li> 
    </ul>  
    <div class="tab-content" xid="div1"> 
      <div class="tab-pane active" xid="tabContent1"> 
        ...
        <div component="$UI/system/components/bootstrap/row/row" class="row"
          xid="row1"> 
          <div class="col col-xs-1 text-right" xid="col1"> 
            <label style="margin-top:9px;">提交人：</label> 
          </div>  
          ...
          <div class="col col-xs-2" xid="col3">
            <a component="$UI/system/components/justep/button/button" class="btn btn-default"
              label="查询" xid="button8" onClick="searchData"> 
              <i xid="i10"/>  
              <span xid="span10">查询</span>
            </a>
          </div> 
        </div>  
        <div component="$UI/system/components/justep/report/report" src="reports/ksqlReport.xml"
