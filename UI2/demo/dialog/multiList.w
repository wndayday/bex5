...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:463px;top:331px;"> 
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="searchData" idColumn="SA_OPOrg" confirmDelete="false" confirmRefresh="false"> 
      <column label="组织ID" name="SA_OPOrg" type="String" xid="default1"/>  
      <column label="名称" name="sName" type="String" xid="default2"/>  
      <data xid="default3">[{"SA_OPOrg":"1","sName":"起步软件"},{"SA_OPOrg":"2","sName":"system"},{"SA_OPOrg":"3","sName":"董事会"},{"SA_OPOrg":"4","sName":"董事长"}]</data>
    </div> 
  </div>  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top container-fluid" xid="top2"> 
      <div component="$UI/system/components/bootstrap/row/row" class="row"
        ...
        <div class="col col-xs-6 col-md-4" xid="col4" style="height:100%;padding-left: 0;"></div>  
