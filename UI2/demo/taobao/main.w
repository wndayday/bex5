                        ...
                        <tr xid="tr1"> 
                          <td bind-click="openPageClick" pagename="./list.w"
                            ...
                            <div class="text-center" xid="div211"> 
                              <img src="./main/img/menu1.png" alt="" xid="image311"
                          ...
                          <td bind-click="openPageClick" pagename="./list.w"
                            ...
                            <div class="text-center" xid="div311"> 
                              <img src="./main/img/menu2.png" alt="" xid="image111"
                                class="img-responsive center-block tb-img5"/>  
                          ...
                          <td bind-click="openPageClick" pagename="./list.w"
                            ...
                            <div class="text-center" xid="div411"> 
                              <img src="./main/img/menu3.png" alt="" xid="image211"
                                class="img-responsive center-block tb-img5"/>  
                              <span xid="span101">淘生活</span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w"
                            xid="td4"> 
                            <div class="text-center" xid="div71"> 
                              <img alt="" xid="image81" src="./main/img/menu4.png"
                                class="img-responsive center-block tb-img5"/>  
                              <span xid="span111">淘点点</span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w"
                            xid="td5"> 
                            <div class="text-center" xid="div81"> 
                              <img alt="" xid="image91" src="./main/img/menu5.png"
                                class="img-responsive center-block tb-img5"/>  
                              <span xid="span121">天猫超市</span> 
                            </div> 
                          </td> 
                        </tr>  
                        <tr xid="tr2"> 
