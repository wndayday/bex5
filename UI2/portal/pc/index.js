define(function(require){
	...
	Model.prototype.setThemeOptions = function(options){
        ...
        var resetLayout = function() {
            ...
            removeClass("page-fluid-compact").
        ...
        if (layoutOption === "fluid-compact") {
            $(".body").addClass("page-fluid-compact");
        }
	...
	var Customizer = function(config, context, enableSave){
		$.extend(this, config);
		this.other = this.other || {};
		this.context = context;
		this.enableSave = enableSave; //TODO: justep.Portal.agentInfo;
	};
	...
	Customizer.prototype = {
		doSave: function(key, data){
			...
			var response = biz.Request.sendBizRequest({
				...
				process : "/portal2/process/portal/portalProcess",
				activity : "index",
				action: action,
				parameters: params,
				context: this.context
			});
			if(!biz.Request.isSuccess(response)){
		...
		save: function(key, data){
			...
			params.setString('personID', this.context.getCurrentPersonID());
			var response = biz.Request.sendBizRequest({
				contentType: "application/json",
				dataType: "application/json",
				process : "/portal2/process/portal/portalProcess",
				activity : "index",
				action: "saveOther3Action",
				parameters: params,
				context: this.context
			});
			if(!biz.Request.isSuccess(response)){
