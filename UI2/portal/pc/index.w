...
<div xmlns="http://www.w3.org/1999/xhtml" xmlns:xu="http://www.xmldb.org/xupdate"
  xmlns:xui="http://www.justep.com/xui" __id="id_1" extends="$UI/portal/base/base.w" 
  ...
  <div class="page-root" style="display: none;" 
      ...
      <div class="page-header-inner"> 
        ...
        <div class="top-menu"> 
          <ul class="nav navbar-nav pull-right"> 
            ...
            <li id="portal-agent" class="dropdown dropdown-user x-portal-agent" style="display:none;"> 
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                data-x5-hover="dropdown" data-close-others="true"> 
                <i class="icon-ios7-browsers"/>  
            ...
            <li class="dropdown dropdown-user"> 
              <a class="dropdown-toggle x-portal-task-wait"> 
                <span class="username username-hide-on-mobile">待办任务<span class="badge" bind-text="waitTaskCount"></span></span>                 
              </a> 
            </li>  
            <li class="dropdown dropdown-user"> 
            ...
            <li class="dropdown dropdown-user"> 
              ...
              <ul class="dropdown-menu dropdown-menu-default"> 
                ...
                <li> 
                  <a component="$UI/system/components/justep/button/button" class="x-portal-setPassWord" icon="icon-ios7-gear-outline"
                    label="修改密码" href="#" xid="changPasswordBtn"> 
  ...
  <div xui:parent="window" xui:update-mode="insert">
	  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="configDialog"
	    src="$UI/portal/pc/config/theme.w" status="normal" width="420px" height="auto"
