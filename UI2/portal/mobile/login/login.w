...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window mobile-login" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:366px;top:7px;"
    onLoad="modelLoad"> 
  ...
  <div class="page-login"> 
    <div class="page-header" style="text-align: center;font-size: 24px; margin-top:0; padding-top: 24px;"> 
      <div class="form-container" align="center">登录我的BeX5</div> 
    </div>  
              ...
              <div component="$UI/system/components/justep/row/row" class="x-row"
                ...
                <div class="x-col lang-switch" xid="col9" style="display:none;">
                  <a component="$UI/system/components/justep/button/button"
                    class="btn btn-link show-langs" label="显示语言选择" xid="showLangBtn" style="padding-left: 0;padding-top: 4px;" onClick="showLangBtnClick"> 
                    <i xid="i3"/>  
                    <span xid="span3">显示语言选择</span>
                  </a>
                  <a component="$UI/system/components/justep/button/button"
                    class="btn btn-link hide-langs" label="隐藏语言选择" xid="hideLangBtn" style="padding-left: 0;display:none;padding-top: 4px;" onClick="hideLangBtnClick"> 
                    <i xid="i11"/>  
                    <span xid="span4">隐藏语言选择</span>
                  </a>
                </div> 
