...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <column label="是否选择集合" name="checked" type="String" xid="xid2"></column></div>
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="fieldNameData" idColumn="fieldName">
   <column isCalculate="false" label="字段名称" name="fieldName" type="String" xid="xid9"></column>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
          ...
          <div class="x-panel-content" xid="content2"> 
            <div component="$UI/system/components/justep/contents/contents"
              ...
              <div class="x-contents-content active" xid="content1"> 
                <div xid="div3" style="display:none;">
   ...
   <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit8">
    <label class="x-label" xid="label8" style="text-align:right">引用字段：</label>
    <div xid="div10" class=" x-edit" style="border:1px solid #aaa;border-radius:5px; padding:6px;">
     <div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="fieldNameData">
      <ul class="x-list-template" xid="listTemplateUl1">
       <li xid="li3">
        <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit9" style="justify-content:flex-start;width:120px;">
         ...
         <span component="$UI/system/components/justep/button/checkbox" class="x-checkbox x-edit " xid="fieldCheckbox" onChange="fieldCheckboxChange" style="text-align:right;" bind-checked=" val(&quot;status&quot;)=='1'"></span></div> </li> </ul> </div> </div> </div> </div></div> 
            </div> 
          </div> 
        </div> 
      </div> 
