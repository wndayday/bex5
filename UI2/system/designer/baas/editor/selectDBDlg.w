...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="modelLoad"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="false"
      xid="dataDB" limit="-1" idColumn="name" confirmRefresh="false" confirmDelete="false"
      onCustomRefresh="dataDBCustomRefresh" onValueChanged="dataDBValueChanged"> 
      <column label="DB" name="name" type="String" xid="xid2"></column>
  <column label="选中" name="checked" type="Boolean" xid="xid5"></column>
  <extendType xid="extendType1">
   <col name="checked" type="sys.boolean" xid="extendTypeCol1"></col></extendType></div>  
    </div>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-content x-flex x-flex-column" xid="content1" style="bottom: 0px;"> 
      <div class="x-control-group x-flex1" style="overflow-y: auto;"> 
        <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true" rowActiveClass="active" class="table table-hover table-striped" xid="dataTables1" data="dataDB" multiSelect="false" ordering="false" onRowClick="dataTables1RowClick"> 
