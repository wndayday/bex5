...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" class="window">  
  ...
  <column label="树形展开列" name="nodeLevelRelation" type="String" xid="default13"></column>
  ...
  <div class="row" style="padding-top:50px"> 
    ...
    <div class="col-xs-9 " style=""> 
      <form class="form-horizontal data-form scroll" style="margin-right:12px"
        ...
        <!--         </div>   -->  
        <div class="form-group"> 
          <label for="text1" class="control-label col-xs-3"><![CDATA[数据对象]]></label>  
          <div class="col-xs-9"> 
            <div class="input-group input-append"> 
              <output component="$UI/system/components/justep/output/output" class="form-control template-detail-output-control"
                xid="concept" bind-value=' $model.mainData.val("conceptName")'/>  
        ...
        <div xid="div1" style="display:none;"><div class="form-group"> 
          ...
          <div class="col-xs-9"> 
            <div class="input-group input-append"> 
              <output component="$UI/system/components/justep/output/output" class="form-control template-detail-output-control" xid="reader" bind-value="mainData.ref('reader')" />  
              <span class="input-group-btn"> 
          ...
          <div class="col-xs-9"> 
            <div class="input-group input-append"> 
              <output component="$UI/system/components/justep/output/output" class="form-control template-detail-output-control" xid="writer" bind-value="mainData.ref('writer')" />  
              <span class="input-group-btn"> 
          ...
          <div class="col-xs-9"> 
            <div class="input-group input-append"> 
              <output component="$UI/system/components/justep/output/output" class="form-control template-detail-output-control" xid="creator" bind-value="mainData.ref('creator')" />  
              <span class="input-group-btn"> 
          ...
          <div class="col-xs-9"> 
            <div class="input-group input-append"> 
              <output component="$UI/system/components/justep/output/output" class="form-control template-detail-output-control" xid="columns" bind-value="mainData.ref('columns')" />  
              <span class="input-group-btn"> 
                <a class="btn btn-default" component="$UI/system/components/justep/button/button" bind-click="selectRelationsBtnClick">选择</a> 
              </span> 
            </div> 
          </div> 
        </div><div class="form-group detail"> 
          <label for="text2" class="control-label col-xs-3">关联关系:</label>  
          <div class="col-xs-9"> 
            <div class="input-group input-append"> 
              <output component="$UI/system/components/justep/output/output" class="form-control template-detail-output-control" xid="column" bind-value="mainData.ref('column')" />  
              <span class="input-group-btn"> 
                <a class="btn btn-default" component="$UI/system/components/justep/button/button" bind-click="selectColumnBtnClick">选择</a> 
              </span>
            </div> 
          </div> 
        </div></div>  
