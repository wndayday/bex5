...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" class="window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:117px;height:auto;left:395px;"
    ...
    <div component="$UI/system/components/justep/data/data" xid="detailData"
      ...
      <column label="数据项列名" name="alias" type="String" xid="default8"/>  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1" height="87">
      <div class="row form-navbar1"> 
        <label for="text1" class="control-label col-xs-2" style="padding-top:10px;"
          bind-click="finish"><![CDATA[从表页标题：]]></label>  
        <div class="col-xs-4"> 
    ...
    <div class="x-panel-content panel-body" xid="content1"> 
      <div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true"
        altRows="true" class="x-grid-no-bordered" xid="grid1" data="detailData" height="100%"
        width="100%"> 
        <columns xid="columns2">
          <column name="labelName" xid="column4"/>
<!--           <column name="data-type" xid="column3"/>  
 -->          <column name="colEditorName" xid="column5" editor="component" editable="true"
