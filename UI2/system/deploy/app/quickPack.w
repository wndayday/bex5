...
<div xmlns="http://www.w3.org/1999/xhtml" xmlns:xui="http://www.justep.com/xui" component="$UI/system/components/justep/window/window" class="window"
  ...
  <span component="$UI/system/components/justep/messageDialog/messageDialog" xid="messageDialogGotoHost" title="提示" message="尚未购买主机或者主机到期或者主机尚未审核，是否现在处理？" type="YesNo" style="top:224px;left:85px;"></span></div>
