...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:mobile">  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"> 
   ...
   <div class="x-control-group-title" xid="controlGroupTitle1">
    <span xid="span1" bind-text="data.val('title')"></span></div> 
   <span bind-text="data.val('wDate')" xid="span2"></span>
   <div bind-foreach="data.datas" xid="div4">
    <p bind-text="val('content')" xid="p1"></p></div> </div></div> 
  </div> 
</div>
