...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:mobile">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="left:18px;top:83px;height:244px;"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <data xid="default4">[{"id":"1","title":"新旗舰即将发布 HTC One Max售4060元","titleImg":"./img/5-1.jpg"},{"id":"2","title":"顶配版Galaxy S5曝光：4G内存/64位处理器","titleImg":"./img/5-2.jpg"},{"id":"3","title":"WP8系统最强手机 诺基亚1520仅售3610","titleImg":"./img/5-3.jpg"},{"id":"4","title":"3G一样很快捷 三星Note 3 N9008售3800","titleImg":"./img/5-4.jpg"},{"id":"5","title":"2014款HTC One再曝光：外观参数已无悬念","titleImg":"./img/5-5.jpg"},{"id":"6","title":"高性能防水4G手机 索尼L39t售3799元","titleImg":"./img/5-6.jpg"},{"id":"7","title":"双卡双待入门级手机 索尼Xperia E1亮相","titleImg":"./img/5-7.jpg"},{"id":"8","title":"iOS 7.1新增应用内购买15分钟免输密码提醒","titleImg":"./img/5-8.jpg"},{"id":"9","title":"实用是真理 2500元级2GB RAM四核机推荐","titleImg":"./img/5-9.jpg"}]</data>
    </div> 
  </div>  
              ...
              <li xid="li1" bind-click="open"> 
                <div component="$UI/system/components/justep/controlGroup/controlGroup"
                  ...
                  <div style="text-align:center"> 
                    <img class="img-responsive x-img1" bind-attr-src="$model.getImageUrl($object)"/> 
                  </div> 
                </div> 
              </li> 
            </ul> 
