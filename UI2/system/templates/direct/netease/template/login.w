...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-card"
      ...
      <div xid="div1" class="list-group"> 
        <div class="list-group-item"> 
          <div class="input-group" xid="div7"> 
            ...
            <input component="$UI/system/components/justep/input/input" class="form-control x-inputText" xid="nameInput" bind-value="'网易邮箱/手机号'"/>
          </div> 
        </div>  
      ...
      <div class="list-group"><div class="list-group-item">
        <div component="$UI/system/components/bootstrap/row/row" class="row panel-heading text-center" xid="row1"> 
          <div class="col col-xs-4 x-nopadding" xid="col5"> 
            <img src="" alt="" bind-attr-src="$model.getImageUrl('./img/user1.png')" class="img3" xid="image2" />  
            <div bind-text="'微信账号登录'" class="text-muted" xid="div15" />
          </div>
          <div class="col col-xs-4 x-nopadding" xid="col6"> 
            <img src="" alt="" bind-attr-src="$model.getImageUrl('./img/user2.png')" class="img3" xid="image1" />  
            <div bind-text="'新浪微博登录'" class="text-muted" xid="div13" />
          </div>
          <div class="col col-xs-4 x-nopadding" xid="col7"> 
            <img src="" alt="" xid="image4" bind-attr-src="$model.getImageUrl('./img/user3.png')" class="img3" />  
   ...
   <i xid="i1" class="icon-ios7-arrow-right text-muted"></i><span xid="span5"></span></a><span xid="span8" class="text-black">没有账号？</span>  
          <span class="text-danger" xid="span9">注册网易邮箱</span>
  </div>
      </div></div>
    </div> 
  </div> 
