...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver x-wangyiOver"
    xid="popOver" style="height:100%;" anchor="navMoreBtn" direction="right-bottom"
    opacity="0.5"> 
    ...
    <div xid="div4" class="x-full x-popOver-content panel"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-left" xid="div5"> 
          <span xid="span7" class="text-muted h5"><![CDATA[切换栏目]]></span> 
        </div>  
        <div class="x-titlebar-title" xid="div6"/>  
        <div class="x-titlebar-right reverse" xid="div7"> 
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon"
            icon="icon-ios7-arrow-up" onClick="{operation:'popOver.hide'}"> 
            <i xid="i9" class="text-muted icon-ios7-arrow-up"/> 
          </a> 
        </div> 
      </div>  
      <div component="$UI/system/components/bootstrap/row/row" class="row x-nomargin x-navGroup panel-body"
        xid="row2"> 
      ...
      <div component="$UI/system/components/bootstrap/row/row" class="row x-nomargin x-navGroup panel-body bg-muted"
        xid="row3"> 
  ...
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver"
    xid="popOverMore" anchor="titleBar1" position="center" style="height:100%;"> 
    <div class="x-popOver-overlay" xid="div13"/>  
    <div class="x-full x-popOver-content panel" xid="div14">
      <div xid="div15" class="panel-body">
        <div xid="div19" class="col-xs-6 pull-left media"><h1 xid="h11" class="media-left text-danger"><![CDATA[21]]></h1>
  <div xid="div27" class="media-body"><span xid="span14" class="text-danger"><![CDATA[℃]]></span>
  <p xid="p1" bind-text="'10/22℃'"></p></div></div>
      <div xid="div26" class="col-xs-6 pull-left text-right"><img src="" alt="" xid="image15" bind-attr-src="$model.getImageUrl('./img/cloud.png')" class="img_cloud"></img><div xid="div28" bind-text="'多云 微风'"></div>
  <div xid="div29" bind-text="'昆明'"></div>
  </div>
  <div xid="div30" class="col-xs-12 pull-left"><span xid="span21"><![CDATA[2015/10/14 星期五]]></span>
  <p xid="p2" bind-text="'PM2.5 24 优'"></p></div></div>  
      <div component="$UI/system/components/bootstrap/row/row" class="row text-center panel-body x-nomargin x-nopadding" xid="row4"> 
          <div class="col col-xs-4 x-nopadding" xid="col12"> 
            <img src="" alt="" bind-attr-src="$model.getImageUrl('./img/more1.png')" class="img3" xid="image5" />  
            <div bind-text="'搜索'" xid="div25" class="text-muted h6"/>
          </div>  
          <div class="col col-xs-4 x-nopadding" xid="col14"> 
            <img src="" alt="" bind-attr-src="$model.getImageUrl('./img/more2.png')" class="img3" xid="image12" />  
            <div bind-text="'上头条'" xid="div24" class="text-muted h6"/>
          </div>  
          <div class="col col-xs-4 x-nopadding" xid="col13"> 
            <img src="" alt="" xid="image5" bind-attr-src="$model.getImageUrl('./img/more3.png')" class="img3" />  
            <div bind-text="'离线'" xid="div23" class="text-muted h6"/>
          </div>
          <div class="col col-xs-4 x-nopadding" xid="col12"> 
            <img src="" alt="" bind-attr-src="$model.getImageUrl('./img/more4.png')" class="img3" xid="image5" />  
            <div bind-text="'夜间'" xid="div25" class="text-muted h6"/>
          </div>
          <div class="col col-xs-4 x-nopadding" xid="col12"> 
            <img src="" alt="" bind-attr-src="$model.getImageUrl('./img/more5.png')" class="img3" xid="image5" />  
            <div bind-text="'扫一扫'" xid="div25" class="text-muted h6"/>
          </div>
          <div class="col col-xs-4 x-nopadding" xid="col12"> 
            <img src="" alt="" bind-attr-src="$model.getImageUrl('./img/more6.png')" class="img3" xid="image5" />  
          ...
          <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
            ...
            <span class="glyphicon glyphicon glyphicon-search form-control-feedback"
              aria-hidden="true"/> 
                ...
                <div class="x-titlebar-right reverse" xid="div3"> 
                  ...
                  <a>
                    <img src="./img/icon24.png" alt="" xid="importantBtn"
              ...
              <div class="x-nav"> 
                <a component="$UI/system/components/justep/button/button"
                  class="btn btn-link btn-only-icon pull-right navMoreBtn" label="button"
                  xid="navMoreBtn" icon="icon-ios7-arrow-down" onClick="{operation:'popOver.show'}"> 
                  <i xid="i19" class="text-muted icon-ios7-arrow-down"/>  
                  <span xid="span17"/> 
                </a>  
                <ul xid="ul1"> 
                  <div component="$UI/system/components/justep/button/buttonGroup"
                    class="btn-group" tabbed="true" xid="buttonGroup3"> 
                    <a component="$UI/system/components/justep/button/button"
                      class="btn btn-link btn-only-label active" label="头条" target="navContent1"> 
                      <i xid="i7"/>  
                      <span xid="span1">头条</span> 
                    </a>  
                    <a component="$UI/system/components/justep/button/button"
                      class="btn btn-link btn-only-label" label="娱乐" target="navContent2"> 
                      <i xid="i1"/>  
                      <span xid="span2">娱乐</span> 
                    </a>  
                    <a component="$UI/system/components/justep/button/button"
                      class="btn btn-link btn-only-label" label="热点" target="navContent3"> 
                      <i xid="i8"/>  
                      <span xid="span8">热点</span> 
                    </a>  
                    <a component="$UI/system/components/justep/button/button"
                      class="btn btn-link btn-only-label" label="体育" target="navContent4"> 
                      <i xid="i12"/>  
                      <span xid="span9">体育</span> 
                    </a>  
                    <a component="$UI/system/components/justep/button/button"
                      class="btn btn-link btn-only-label" label="昆明" target="navContent5"> 
                      <i xid="i13"/>  
                      <span xid="span10">昆明</span> 
                    </a>  
                    <a component="$UI/system/components/justep/button/button"
                      class="btn btn-link btn-only-label" label="财经" target="navContent6"> 
                      <i xid="i14"/>  
                      <span xid="span11">财经</span> 
                    </a>  
                    <a component="$UI/system/components/justep/button/button"
                      class="btn btn-link btn-only-label" label="科技" target="navContent7"> 
                      <i xid="i16"/>  
                      <span xid="span13">科技</span> 
                    </a>  
                    <a component="$UI/system/components/justep/button/button"
                      class="btn btn-link btn-only-label" label="图片" target="navContent8"> 
                      <i xid="i17"/>  
                      <span xid="span15">图片</span> 
                    </a>  
                    <a component="$UI/system/components/justep/button/button"
                      class="btn btn-link btn-only-label" label="跟贴" target="navContent9"> 
                      <i xid="i18"/>  
                      <span xid="span16">跟贴</span> 
                    </a> 
                  </div> 
                </ul> 
              </div> 
            ...
            <div class="x-panel-content" xid="content1"> 
              <div component="$UI/system/components/justep/contents/contents"
                    ...
                    <div class="x-contents carousel-inner" role="listbox" component="$UI/system/components/justep/contents/contents"
                      ...
                      <div class="x-contents-content" xid="banner1"> 
                        <img alt="" xid="image1" id="image1" class="image-wall img1"
                          bind-attr-src="$model.getImageUrl('./img/1.jpg')"/>  
                      ...
                      <div class="x-contents-content" xid="banner2"> 
                        <img alt="" xid="image2" id="image2" class="image-wall img1"
                          bind-attr-src="$model.getImageUrl('./img/2.jpg')"/>  
                      ...
                      <div class="x-contents-content" xid="banner3"> 
                        <img alt="" xid="image13" id="image13" class="image-wall img1"
                          bind-attr-src="$model.getImageUrl('./img/3.jpg')"/>  
                      ...
                      <div class="x-contents-content" xid="banner4"> 
                        <img alt="" xid="image14" id="image14" class="image-wall img1"
                          bind-attr-src="$model.getImageUrl('./img/4.jpg')"/>  
                    ...
                    <div component="$UI/system/components/justep/list/list"
                      ...
                      <ul class="x-list-template" xid="listTemplateUl1" bind-click="detailClick"> 
                        <li xid="li1" class="list-group-item x-flex"> 
                          ...
                          <div class="x-flex1" xid="col26"> 
                            <h5 bind-text="ref('fTitle')" xid="h53"/>  
                            <span style="text-align: justify;" bind-text="ref('fOmit')"
                ...
                <div class="x-contents-content" xid="navContent2" onActive="navContentActive"> 
                  <div component="$UI/system/components/justep/windowContainer/windowContainer"
                    class="x-window-container" xid="navContainer2" style="height:100%;width:100%;" src="./index_main2.w" autoLoad="false"/> 
                </div>  
                <div class="x-contents-content" xid="navContent3" onActive="navContentActive"> 
                  <div component="$UI/system/components/justep/windowContainer/windowContainer"
                    class="x-window-container" xid="navContainer3" style="height:100%;width:100%;" src="./index_main2.w" autoLoad="false"/> 
                </div>  
                <div class="x-contents-content" xid="navContent4" onActive="navContentActive"> 
                  <div component="$UI/system/components/justep/windowContainer/windowContainer"
                    class="x-window-container" xid="navContainer4" style="height:100%;width:100%;" src="./index_main2.w" autoLoad="false"/> 
                </div>  
                <div class="x-contents-content" xid="navContent5" onActive="navContentActive"> 
                  <div component="$UI/system/components/justep/windowContainer/windowContainer"
                    class="x-window-container" xid="navContainer5" style="height:100%;width:100%;" src="./index_main2.w" autoLoad="false"/> 
                </div>  
                <div class="x-contents-content" xid="navContent6" onActive="navContentActive"> 
                  <div component="$UI/system/components/justep/windowContainer/windowContainer"
                    class="x-window-container" xid="navContainer6" style="height:100%;width:100%;" src="./index_main2.w" autoLoad="false"/> 
                </div>  
                <div class="x-contents-content" xid="navContent7" onActive="navContentActive"> 
                  <div component="$UI/system/components/justep/windowContainer/windowContainer"
                    class="x-window-container" xid="navContainer7" style="height:100%;width:100%;" src="./index_main2.w" autoLoad="false"/> 
                </div>  
                <div class="x-contents-content" xid="navContent8" onActive="navContentActive"> 
                  <div component="$UI/system/components/justep/windowContainer/windowContainer"
                    class="x-window-container" xid="navContainer8" style="height:100%;width:100%;" src="./index_main2.w" autoLoad="false"/> 
                </div>  
                <div class="x-contents-content" xid="navContent9" onActive="navContentActive"> 
                  <div component="$UI/system/components/justep/windowContainer/windowContainer"
                    class="x-window-container" xid="navContainer9" style="height:100%;width:100%;" src="./index_main2.w" autoLoad="false"/> 
                </div> 
              </div> 
            </div> 
          </div> 
        </div>  
        <div class="x-contents-content" xid="readContent" onActive="contentActive"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="readContainer" style="height:100%;width:100%;" src="./index-read.w" autoLoad="false"/> 
        </div>  
        <div class="x-contents-content" xid="audioContent" onActive="contentActive"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="audioContainer" src="./index-audio.w" autoLoad="false"/> 
        </div>  
        <div class="x-contents-content" xid="foundContent" onActive="contentActive"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="foundContainer" src="./index-found.w" autoLoad="false"/> 
        </div>  
        <div class="x-contents-content" xid="userContent" onActive="contentActive"> 
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="userContainer" src="./index-user.w" autoLoad="false"/> 
        </div> 
      </div> 
    </div>  
