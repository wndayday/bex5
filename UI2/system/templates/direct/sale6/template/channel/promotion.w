...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:mobile">  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-card"> 
   ...
   <div component="$UI/system/components/justep/titleBar/titleBar" title="促销活动" class="x-titlebar" xid="titleBar1">
    ...
    <div class="x-titlebar-right reverse" xid="div3"></div></div> </div><div class="x-panel-content x-cards x-scroll-view" style="bottom: 0px;"> 
   ...
   <div class="x-scroll-content" xid="div5"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="data" limit="5"> 
        <ul class="x-list-template" xid="listTemplateUl1"> 
          <li xid="li1" class="col-xs-12" bind-click="open"> 
            <div class="thumbnail media">
              <div class="media-left">
                <img bind-attr-src="$model.getImageUrl(val('imgSrc'))" width="93" class="x-img1" />
              </div>  
   ...
   <div class="x-content-center x-pull-up" xid="div6">
    <span class="x-pull-up-label" xid="span6">加载更多...</span></div> </div>  
      </div> 
  </div> 
</div>
