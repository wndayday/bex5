...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" class="window">
	<div component="$UI/system/components/justep/model/model" xid="model" style="top:117px;height:auto;left:395px;" onLoad="modelLoad">
		<div component="$UI/system/components/justep/data/data" xid="formData"
			...
			<column label="关系类型" name="dataType" type="String" xid="default2" />
	...
	<div class="row form-navbar1" style="margin-top:12px">
		...
		<div class="col-xs-4" xid="col1">
			<input component="$UI/system/components/justep/input/input" class="form-control" xid="titleInput" placeholder="请输入标题" bind-ref="title"/>
		</div>
	</div>
...
<span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog" src="$UI/system/templates/common/selectColsDialog.w" status="normal" onReceive="windowDialogReceive" width="90%" height="90%"></span></div>
