        ...
        <div class="form-group"> 
          ...
          <div class="col-xs-9"> 
            <div class="input-group input-append"> 
              <input component="$UI/system/components/justep/input/input" class="form-control  template-output-control" xid="concept" bind-value="mainData.ref('concept')"></input><span class="input-group-btn"> 
