  ...
  <div component="$UI/system/components/justep/wing/wing" class="x-wing" xid="wing"
    ...
    <div class="x-wing-content" xid="content1"> 
      ...
      <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
        active="0" xid="pages" slidable="true" wrap="false"><div class="x-contents-content" xid="main"><div component="$UI/system/components/justep/windowContainer/windowContainer" class="x-window-container" xid="mainContainer" src="./main.w"></div></div></div> 
    </div>  
    </div> 
</div>
