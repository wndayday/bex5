...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window">  
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="modelLoad"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <column label="vertical" name="vertical" type="String" xid="default1"/>  
      <column label="horizontal" name="horizontal" type="String" xid="default5"/>  
      <data xid="default6">[{"vertical":"LEFT","horizontal":"TOP"},{"vertical":"CENTER","horizontal":"CENTER"},{"vertical":"RIGHT","horizontal":"BOTTOM"}]</data>
    </div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <data xid="default35">[{"id":"1","chartTitle":"Justep图表","chartPosition":"TOP","isshow":"false","vertical":"CENTER","horizontal":"CENTER","fontType":"宋体","fontStyle":"0","fontSize":"18"}]</data> 
    </div> 
  </div>  
  <div id="index"> 
    <span component="$UI/system/components/justep/button/checkbox" class="x-checkbox"
      xid="checkbox1" label="图表是否显示注释信息" checked="false" checkedValue="true" onChange="checkbox1Change"/>  
    <div class="istrue" style="display:none"> 
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2"> 
        ...
        <div class="x-col" xid="col4"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            class="x-label-edit x-label40" xid="labelSelect2"> 
        ...
        <div class="x-col" xid="col5"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            class="x-label-edit x-label40" xid="labelSelect3"> 
      ...
      <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3"> 
        <div class="x-col" xid="col6"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            class="x-label-edit x-label40" xid="labelSelect4"> 
        ...
        <div class="x-col" xid="col7"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            class="x-label-edit x-label40" xid="labelSelect5"> 
        ...
        <div class="x-col" xid="col8"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            class="x-label-edit x-label40" xid="labelSelect6"> 
