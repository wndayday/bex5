...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:307px;top:559px;"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <column label="titleName" name="titleName" type="String" xid="default1"/>  
      <column label="titlefontName" name="titlefontName" type="String" xid="default2"/>  
      <column label="titlefontStyle" name="titlefontStyle" type="String" xid="default3"/>  
      <column label="titlefontSize" name="titlefontSize" type="String" xid="default12"/>  
      <column label="margin" name="margin" type="String" xid="default13"/>  
      <column label="upperMargin" name="upperMargin" type="String" xid="default14"/>  
      <column label="lowerMargin" name="lowerMargin" type="String" xid="default15"/>  
      <column label="labelWidth" name="labelWidth" type="String" xid="default16"/>  
      <column label="tickfontName" name="tickfontName" type="String" xid="default17"/>  
      <column label="tickfontStyle" name="tickfontStyle" type="String" xid="default18"/>  
      <column label="tickfontSize" name="tickfontSize" type="String" xid="default19"/>  
      <column label="labelAngle" name="labelAngle" type="String" xid="default20"/>  
      <column label="itemfontName" name="itemfontName" type="String" xid="default21"/>  
      <column label="itemfontType" name="itemfontType" type="String" xid="default22"/>  
      <column label="itemfontSize" name="itemfontSize" type="String" xid="default23"/>  
      <column label="itemMargin" name="itemMargin" type="String" xid="default24"/>  
      <column label="itemMaxWid" name="itemMaxWid" type="String" xid="default25"/>  
      <column label="itemOutLine" name="itemOutLine" type="String" xid="default26"/>  
      <column label="itemNumFm" name="itemNumFm" type="String" xid="default27"/>  
      <column label="isVisible" name="isVisible" type="String" xid="default28"/>  
      <column label="dateRound" name="dateRound" type="String" xid="default29"/>  
      <column label="dateType" name="dateType" type="String" xid="default30"/>  
      <data xid="default31">[{"titleName":"分类","titlefontName":"黑体","titlefontStyle":"0","titlefontSize":"12","tickfontName":"黑体","tickfontStyle":"0","tickfontSize":"12","itemfontName":"黑体","itemfontType":"0","itemfontSize":"12","itemMargin":"0.2","itemMaxWid":"0.4","itemOutLine":"0.3f","itemNumFm":"######.00","isVisible":"false","dateRound":"day","dateType":"yyyy-MM-dd"}]</data> 
    </div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="selectData" idColumn="alpha"> 
      <column label="alpha" name="alpha" type="String" xid="default38"/>  
      <column label="laGap" name="laGap" type="String" xid="default39"/>  
      <data xid="default40">[{"alpha":"0.1f","laGap":"0.1"},{"alpha":"0.2f","laGap":"0.2"},{"alpha":"0.3f","laGap":"0.3"},{"alpha":"0.4f","laGap":"0.4"},{"alpha":"0.5f","laGap":"0.5"},{"alpha":"0.6f","laGap":"0.6"},{"alpha":"0.7f","laGap":"0.7"},{"alpha":"0.8f","laGap":"0.8"},{"alpha":"0.9f","laGap":"0.9"},{"alpha":"1.0f","laGap":"1.0"}]</data>
    </div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="datedata" idColumn="id"> 
      <column label="id" name="id" type="String" xid="default34"/>  
      <column label="dateRound" name="dateRound" type="String" xid="default35"/>  
      <data xid="default37">[{"id":"1","dateRound":"year"},{"id":"2","dateRound":"month"},{"id":"3","dateRound":"day"},{"id":"4","dateRound":"hour"},{"id":"5","dateRound":"minute"},{"id":"6","dateRound":"second"},{"id":"7","dateRound":"millisecond"},{"id":"8","dateRound":"fixedmillisecond"}]</data> 
    </div> 
  </div>  
  <div id="index" style="height:100%"> 
    ...
    <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2"
      ...
      <div class="x-col" xid="col4"> 
        <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label40"
          xid="labelSelect4"> 
          <label class="x-label" xid="label5" style="width:140px;"><![CDATA[日期周期：]]></label>  
          <select component="$UI/system/components/justep/select/select" class="form-control x-edit"
            xid="select4" bind-ref="data.ref('dateRound')" bind-options="datedata"
            bind-optionsLabel="dateRound" bind-optionsValue="dateRound"/> 
        </div> 
      </div>  
      <div class="x-col" xid="col5"> 
        <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label40"
          xid="labelInput2"> 
          <label class="x-label" xid="label6"><![CDATA[日期格式：]]></label>  
          <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
            xid="input2" bind-ref="data.ref('dateType')"/> 
        </div> 
      </div>  
