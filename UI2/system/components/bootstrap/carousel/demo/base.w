...
<a component="$UI/system/components/justep/button/button" class="btn btn-default" label="next" xid="button1" onClick='{"operation":"carousel1.next"}'>
   <i xid="i1"></i>
   <span xid="span5">next</span></a>
  <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="add" xid="button2" style="margin-left: 10px;" onClick="button2Click">
   <i xid="i2"></i>
   <span xid="span6">add</span></a></div>
