...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window">  
  ...
  <div component="$UI/system/components/justep/bar/bar" class="x-bar" xid="bar1" style="background:white;"><a component="$UI/system/components/justep/button/button" class="btn btn-default" label="创建Menu项" xid="button6" onClick="button6Click">
   <i xid="i6"></i>
   <span xid="span6">创建Menu项</span></a>
  <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="创建分隔符" xid="button7" style="margin-left:10px" onClick="button7Click">
   <i xid="i7"></i>
   <span xid="span7">创建分隔符</span></a></div></div>  
