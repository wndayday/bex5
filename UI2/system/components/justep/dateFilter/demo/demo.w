  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1">
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-right reverse" xid="div4"><a component="$UI/system/components/justep/button/button" class="btn btn-default" label="上周" xid="button1" onClick="button1Click">
   <i xid="i1"></i>
   <span xid="span1">上周</span></a></div>
      </div>
    </div>  
