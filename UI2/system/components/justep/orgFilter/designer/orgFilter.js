...
//	var $ = require("jquery");
	...
	var quickIdeEx = {
			"$UI/system/components/justep/orgFilter/orgFilter":{
				properties:["xid","filterData","orgFIDCol","personIDCol","useMyself","defaultValue","autoRefresh"],
				events:["onFilter"],
	...
	return {'$UI/system/components/justep/orgFilter/orgFilter': DOrgFilter,quickIdeEx:quickIdeEx};
});