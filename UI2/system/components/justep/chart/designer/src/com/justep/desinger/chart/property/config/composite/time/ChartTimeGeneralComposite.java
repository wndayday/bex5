...
public class ChartTimeGeneralComposite extends Composite implements IChartComposite{
	...
	public ChartTimeGeneralComposite(Composite parent, int style,XuiElement owerElement ,String currentChartType) {
		super(parent, style);
