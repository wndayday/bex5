...
public class ChartLineMapComposite extends Composite implements IChartComposite{
	...
	public ChartLineMapComposite(Composite parent, int style,XuiElement owerElement ,String currentChartType) {
		super(parent, style);
	...
	public void initLayout() {
		...
		final GridData gd_text_map_tool_tip_label_style = new GridData(SWT.FILL, SWT.FILL, true, false);
		...
		combo_map_tool_tip_formatType.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));
		...
		text_marker_value.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));
