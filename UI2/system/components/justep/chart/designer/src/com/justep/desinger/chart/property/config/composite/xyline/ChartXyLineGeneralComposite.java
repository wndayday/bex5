...
public class ChartXyLineGeneralComposite extends Composite implements IChartComposite{
	...
	public ChartXyLineGeneralComposite(Composite parent, int style,XuiElement owerElement ,String currentChartType) {
		super(parent, style);
	...
	public void initLayout() {
		...
		label.setLayoutData(new GridData(77, 22));
		label.setText("其他");
		...
		combo_background_alpha.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 2, 1));
		...
		combo_foreground_alpha.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 2, 1));
