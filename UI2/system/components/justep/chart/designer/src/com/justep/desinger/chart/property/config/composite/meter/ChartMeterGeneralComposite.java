...
public class ChartMeterGeneralComposite extends Composite implements IChartComposite{
	...
	public ChartMeterGeneralComposite(Composite parent, int style,XuiElement owerElement ,String currentChartType) {
		super(parent, style);
	...
	public void initLayout() {
		...
		final GridData gd_text_bgcolor = new GridData(SWT.FILL, SWT.FILL, true, false);
		gd_text_bgcolor.widthHint = 390;
		...
		button_text_bgcolor = new Button(this, SWT.NONE);
		...
		combo_background_alpha.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 2, 1));
		...
		combo_foreground_alpha.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 2, 1));
