...
public class ChartLineMarkerComposite extends Composite implements IChartComposite{
	...
	public ChartLineMarkerComposite(Composite parent, int style,XuiElement owerElement ,String currentChartType) {
		super(parent, style);
	...
	public void initLayout() {
		...
		final GridData gd_text_marker_value = new GridData(SWT.FILL, SWT.FILL, true, false);
		gd_text_marker_value.widthHint = 257;
		...
		final GridData gd_combo_marker_label_fontName = new GridData(SWT.FILL, SWT.FILL, true, false);
		gd_combo_marker_label_fontName.widthHint = 76;
		...
		combo_marker_label_fontStyle.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));
		...
		combo_marker_label_fontSize.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));
	...
	public void saveSelfConfig() {
		...
		String visible = ""+button_marker_visiable.getSelection();
