...
public class ChartAreaMapComposite extends Composite implements IChartComposite{
	...
	public ChartAreaMapComposite(Composite parent, int style,XuiElement owerElement ,String currentChartType) {
		super(parent, style);
	...
	public void initLayout() {
		...
		text_map_tool_tip_label_style.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));
		...
		combo_map_tool_tip_formatType.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));
		...
		text_marker_value.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));
