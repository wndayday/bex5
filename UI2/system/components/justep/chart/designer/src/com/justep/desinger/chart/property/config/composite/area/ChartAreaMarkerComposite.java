...
public class ChartAreaMarkerComposite extends Composite implements IChartComposite{
	...
	public ChartAreaMarkerComposite(Composite parent, int style,XuiElement owerElement ,String currentChartType) {
		super(parent, style);
	...
	public void initLayout() {
		...
		label.setLayoutData(new GridData(521, 26));
		label.setText("警戒线");
		...
		gd_text_marker_value.widthHint = 232;
		...
		gd_text_marker_color.widthHint = 12;
		...
		combo_marker_label_fontName.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));
