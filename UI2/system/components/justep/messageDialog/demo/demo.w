  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="position:absolute;;left:14.0px;top:155.0px" onLoad="modelLoad"></div><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-content" xid="content1"> 
      <div component="$UI/system/components/justep/controlGroup/controlGroup"
        ...
        <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label25" xid="labelInput1">
   <label class="x-label" xid="label1"><![CDATA[inputValue：]]></label>
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input1" bind-value="inputValue"></input></div></div>  
        <div xid="buttons"> 
