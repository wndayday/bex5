...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window">  
  ...
  <div data="mainData" component="$UI/system/components/justep/dataTables/dataTables" class="table table-striped table-hover text-nowrap x-dt-title-center" xid="example" lengthMenu="10,20,50,100" flexibleWidth="true" rowActiveClass="active" multiSelect="true" pageLength="20" useFooter="true" responsive="true">
	  <columns>
