  ...
  <div xid="view"> 
    <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"
      ...
      <a component="$UI/system/components/justep/button/button" label=" 新建"
        class="btn btn-link btn-icon-left blackBtn" icon="icon-plus" onClick="{&quot;operation&quot;:&quot;{{list_data}}.new&quot;, args:{index:'js:0'}}"
        xid="newBtn"> 
        <i class="icon-plus"/>  
        <span>新建</span> 
      </a>  
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
        label="保存" xid="saveBtn" onClick="{&quot;operation&quot;:&quot;{{list_data}}.save&quot;}" icon="glyphicon glyphicon-floppy-save"> 
        <i xid="i3" class="glyphicon glyphicon-floppy-save"/>  
        <span xid="label7">保存</span> 
      </a>  
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
        label="删除" xid="deleteBtn" onClick="{&quot;operation&quot;:&quot;{{list_data}}.delete&quot;}" icon="linear linear-volumemedium"> 
        <i xid="i4" class="linear linear-volumemedium"/>  
        <span xid="span7">删除</span> 
      </a>  
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
        xid="refreshBtn" onClick="{&quot;operation&quot;:&quot;{{list_data}}.refresh&quot;}" label="刷新" icon="linear linear-redo"> 
        <i xid="i2" class="linear linear-redo"/>  
