          ...
          <div component="$UI/system/components/justep/titleBar/titleBar" 
            ...
            <div class="x-titlebar-right reverse"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon"
                onClick="{operation:'contents.to','args':{'xid':'detailView'}}"
                icon="icon-android-mixer"> 
      ...
      <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
        ...
        <div class="x-panel-content" xid="content1"> 
          <div component="$UI/system/components/justep/controlGroup/controlGroup"
            ...
            <div class="x-control-group-title" xid="controlGroupTitle1" style="display:none;"> 
                ...
                <div component="$UI/system/components/justep/row/row" class="x-row x-order-detail"
                  ...
                  <div xid="col2" class="x-col x-col-10 x-col-center"> 
                    <a component="$UI/system/components/justep/button/button"
                      ...
                      <i xid="i5" class="icon-close row-icon" style="color:#FF0000;"/>  
                      <span xid="span5"/>
                    </a>
                  </div> 
                </div> 
