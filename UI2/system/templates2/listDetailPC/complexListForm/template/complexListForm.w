...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:pc" xid="window">  
  ...
  <div xid="view"> 
    <div component="$UI/system/components/justep/controlGroup/controlGroup"
      class="x-control-group o-noPadding" title="{{list_title}}" xid="mainControlGroup" collapsible="true"> 
      ...
      <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline" xid="mainBar"> 
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
          xid="newBtn" label="新建" onClick='{operation:"mainData.new"}' icon="icon-plus"> 
          <i xid="i8" class="icon-plus"/>  
          <span xid="span8">新建</span> 
        </a>  
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
          xid="saveBtn" onClick='{"operation":"mainData.save"}' label="保存" icon="glyphicon glyphicon-floppy-save"> 
          <i xid="i7" class="glyphicon glyphicon-floppy-save"/>  
    ...
    <div component="$UI/system/components/justep/controlGroup/controlGroup"
      class="x-control-group o-noPadding" title="{{detail_title}}" xid="detailControlGroup" collapsible="true"> 
      ...
      <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter" xid="detailBar"> 
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
          xid="deleteBtn" onClick="{operation:'{{detail_data}}.delete'}" icon="linear linear-volumemedium"> 
          <i xid="i17" class="linear linear-volumemedium"/>  
