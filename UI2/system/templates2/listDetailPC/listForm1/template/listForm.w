...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  ...
  <div component="$UI/system/components/bootstrap/tabs/tabs" xid="tabs"> 
    <ul class="nav nav-tabs o-navMenu" xid="navs"> 
      ...
      <div class="tab-pane active" xid="list"> 
        <div xid="bar" component="$UI/system/components/justep/toolBar/toolBar"
          ...
          <a component="$UI/system/components/justep/button/button" label=" 新建"
            class="btn btn-link btn-icon-left blackBtn" icon="icon-plus" onClick='[{"operation":"mainData.new"},{"operation":"tabs.setActiveTab","args":{"tab":"nav-detail"}}]'> 
            <i class="icon-plus"/>  
            <span>新建</span> 
          </a>  
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
            xid="button4" onClick='{"operation":"dataOperation.deleteData","args":{"data":"mainData"}}' label="删除" icon="icon-minus"> 
        ...
        <div component="$UI/system/components/justep/dataTables/dataTables"
          flexibleWidth="true" {{#if col_more}}scrollX="1"{{/if}} class="table table-hover hidder-xs x-bordered" xid="listData"
          data="{{list_data}}" rowActiveClass="active" onRowDblClick='{"operation":"tabs.setActiveTab","args":{"tab":"nav-detail"}}' responsive="false"> 
      ...
      <div class="tab-pane" xid="detail"> 
        <div xid="detailBar" component="$UI/system/components/justep/toolBar/toolBar"
          ...
          <a component="$UI/system/components/justep/button/button" label="添加"
            class="btn btn-link btn-icon-left blackBtn" icon="icon-plus" onClick='{"operation":"mainData.new"}'
            xid="newBtn2"> 
            <i class="icon-plus" xid="i3"/>  
            <span xid="span1">添加</span> 
          </a>  
          <a component="$UI/system/components/justep/button/button" label=" 保存"
            class="btn btn-link btn-icon-left blackBtn" onClick="{operation:'mainData.save'}"
            xid="saveBtn"> 
            <i/>  
            <span>保存</span> 
          </a>  
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
            label="删除" xid="button2" icon="icon-minus" onClick='[{"operation":"dataOperation.deleteData","args":{"data":"mainData"}},{"operation":"tabs.setActiveTab","args":{"tab":"nav-list"}}]'> 
        ...
        <div class="container-fluid x-bordered"> 
