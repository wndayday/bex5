      ...
      <div class="tab-pane active container-fluid" xid="listContent"> 
        <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline" xid="listBar"> 
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
            icon="icon-image" xid="chartBtn" onClick='{"operation":"process.showChart"}'> 
        ...
        <div component="$UI/system/components/justep/dataTables/dataTables"
          ...
          xid="list" data="{{list_data}}"  onRowDblClick='{"operation":"tabs.setActiveTab","args":{"tab":"detailLi"}}'> 
      ...
      <div class="tab-pane" xid="detailContent"> 
        <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline" xid="detailBar"> 
          <div component="$UI/system/components/justep/button/buttonGroup"
            ...
            <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
              icon="icon-image" xid="chart2Btn" onClick='{"operation":"process.showChart"}'> 
              <i xid="i9" icon="icon-image" class="icon-image"/>  
              <span xid="span9">流程图</span> 
            </a>  
            <a component="$UI/system/components/justep/button/button" class="btn btn-link blackBtn"
        ...
        <div xid="mainForm" class="form-horizontal container-fluid x-bordered panel-body" component="$UI/system/components/bootstrap/form/form">{{#each form1}}
