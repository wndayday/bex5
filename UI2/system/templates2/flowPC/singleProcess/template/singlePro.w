...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:pc" xid="window">  
  ...
  <div xid="view" class="panel-body"> 
    ...
    <div xid="content"> 
      ...
      <div xid="mainForm" class="form-horizontal container-fluid x-bordered" component="$UI/system/components/bootstrap/form/form">{{#each form1}} 
        <div xid="formGroup{{addOne @index}}" class="form-group"> 
          ...
          <div xid="col{{addOne @index}}2" class="col-sm-4">{{#if form_selectDataID}}
            <select class="form-control" component="$UI/system/components/justep/select/select"
              ...
              bind-optionsValue="{{form_selectConcept}}" bind-optionsCaption="请选择..." xid="{{fieldName1}}"/>{{else}}{{#if passwordfieldName1}}
            ...
            <output xid="{{fieldName1}}" class="x-output" component="$UI/system/components/justep/output/output"
