  ...
  <div xid="view"> 
    <div xid="mainForm" class="form-horizontal container-fluid" component="$UI/system/components/bootstrap/form/form"> 
      <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
          xid="saveBtn" onClick="{operation:'mainData.save'}" icon="glyphicon glyphicon-floppy-save"
          label="保存"> 
      ...
      <div class="panel-body x-bordered">{{#each form1}} 
    ...
    <div component="$UI/system/components/justep/controlGroup/controlGroup"
      ...
      <div> 
        <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"
          xid="detailBar"> 
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
            xid="addBtn" icon="icon-plus" onClick="{operation:'detailData.new'}" label="添加"> 
            <i xid="i6" class="icon-plus"/>  
            <span xid="span10"/> 
          </a>  
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left blackBtn"
            xid="deleteBtn" onClick="{operation:'detailData.delete'}" label="删除" icon="linear linear-volumemedium"> 
        ...
        <div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true"
          ...
          <columns xid="column">{{#each detail_list}}
            <column name="{{list_field1}}" editable="true"
              editor="input"></column>{{#if list_field2}}
            <column name="{{list_field2}}" editable="true"
              editor="input"></column> {{/if}}{{/each}}
          </columns> 
        </div> 
      </div> 
    </div> 
