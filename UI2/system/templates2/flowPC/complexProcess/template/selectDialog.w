...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:260px;top:346px;" onParamsReceive="modelParamsReceive">{{#each detailFormData}} 
  ...
  <div xid="view" class="panel-body"> 
    <div class="form-horizontal container-fluid x-bordered panel-body" component="$UI/system/components/bootstrap/form/form"> 
      {{#each detailForm}}
      ...
      <div class="x-panel-bottom" style="text-align:right;padding-top:5px;"
        xid="panelPanel"> 
        <a class="btn btn-default x-dialog-button" component="$UI/system/components/justep/button/button" label="取    消" onClick='{"operation":"window.close"}' xid="cancelBtn"> 
          <i xid="i4_1" />  
          <span xid="span4_1">取 消</span> 
        </a><a class="btn btn-primary x-dialog-button" component="$UI/system/components/justep/button/button"
          label="确    定" onClick="okBtnClick" xid="okBtn"> 
          <i xid="i3_1"/>  
