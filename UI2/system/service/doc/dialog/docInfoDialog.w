     ...
     <xhtml:div component="/UI/system/components/borderLayout.xbl.xml#borderLayout" 
      	style="width:100%;height:100%" border-size="8px" id="border1">
              ...
              <xui:tab> 
                ...
                <xhtml:table width="100%"> 
                  ...
                  <xhtml:tr style="height:120px"> 
                    ...
                    <xhtml:td> 
                      <xforms:textarea id="docDescTextarea" xforms:rows="4" xforms:cols="75" ref="instance('docInfo')/sDescription" style="width:100%;height:250px;margin-top:10px"/> 
                    </xhtml:td>  
                    <xhtml:td/> 
                  </xhtml:tr>  
	       ...
	       <bottom id="bot__" size="30px">
	            <xui:place control="trigger2" id="controlPlace2" style="float:right;width:75px;margin-top:8px;"></xui:place><xui:place control="trigger1" id="controlPlace1" style="float:right;width:75px;margin-top:8px;margin-right:8px;"></xui:place>
  </bottom>
       </xhtml:div>
    </xui:layout> 
