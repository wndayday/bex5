...
public class FunctionTreeForPC implements com.justep.ui.JProcessor {
	
	public void execute(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException{
		Object result = com.justep.ui.system.service.permission.FunctionTree.executeForPC(request, "/" + JustepConfig.getUIValue(NetUtils.getRequestPath(request)));
		String buf = null;
