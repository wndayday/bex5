...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:144px;top:311px;"> 
    <div component="$UI/system/components/justep/data/bizData" xid="leaveApplyData"
      concept="OA_LeaveApply" autoNew="false" autoLoad="false"> 
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-left" xid="div1" style="width:101px;"> 
          <a component="$UI/system/components/justep/button/button" class="btn btn-link"
            xid="closeBtn" onClick="closeBtnClick"
        ...
        <div class="x-titlebar-right reverse" xid="div3" style="width:188px;"><a component="$UI/system/components/justep/button/button" class="btn btn-link" xid="chartBtn" icon="icon-android-keypad" onClick="chartBtnClick">
   <i xid="i1" class="icon-android-keypad"></i>
        ...
        <div class="media-body" xid="div8"> 
          <div xid="divName" class="content-first-row"> 
            <div component="$UI/system/components/justep/output/output" class="x-output title-data"
              xid="outputName" bind-ref="leaveApplyData.ref('fCreator')" /> 
          </div>  
