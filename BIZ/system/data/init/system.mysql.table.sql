...
alter table SA_TaskRelation_SysBak
  add constraint PK_TASKRELATION_SysBak primary key (sTaskID1, sTaskID2);
...
alter table SA_TaskRelation_Histroy
  add constraint PK_TASKRELATION_Histroy primary key (sTaskID1, sTaskID2);
