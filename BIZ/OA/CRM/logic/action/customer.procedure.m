...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="queryOA_CustomerLetterProcedure" code-model="/OA/CRM/logic/code" code="Customer.queryOA_CustomerLetter"> 
  ...
  <procedure name="queryOA_CustomerSelectProcedure" code-model="/OA/CRM/logic/code" code="Customer.queryOA_CustomerLetter">
    <parameter name="concept" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
    <parameter name="aggregate" type="String"/>
