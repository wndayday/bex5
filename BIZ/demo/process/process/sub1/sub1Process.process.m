...
<model xmlns="http://www.justep.com/model">
	<process name="sub1Process" start="start1" end="end1">
...
<business-activity name="businessActivity1" condition="true"><label language="zh_CN">活动环节1-子流程1</label>
<input name="x" unit="start1"></input>
<output name="x" unit="businessActivity2"></output>
</business-activity>
<business-activity name="businessActivity2" condition="true"><label language="zh_CN">活动环节2-子流程1</label>
<input name="x" unit="businessActivity1"></input>
<output name="x" unit="businessActivity3"></output>
</business-activity>
<business-activity name="businessActivity3" condition="true"><label language="zh_CN">活动环节3-子流程1</label>
...
<listener action="startProcessAction" event="after" handler="sub1ProcessAfterStartProcedure"></listener>
<listener action="finishProcessAction" event="before" handler="sub1ProcessBeforeFinishProcedure"></listener>
</process>
</model>
