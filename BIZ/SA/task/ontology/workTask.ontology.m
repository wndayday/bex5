<model xmlns="http://www.justep.com/model">
	<concept name="SA_WorkTask" default-value-expr="guid()">
		...
		<has-relation relation="sCURL" default-value-expr="'/SA/task/workTask/useActivity.a'"/>
		<has-relation relation="sEURL" default-value-expr="'/SA/task/workTask/useActivity.a'"/>
