<model xmlns="http://www.justep.com/model">
	<concept name="SA_WorkRecord" default-value-expr="guid()">
		...
		<has-relation relation="sCURL" default-value-expr="'/SA/task/workRecord/useActivity.a'"/>
		<has-relation relation="sEURL" default-value-expr="'/SA/task/workRecord/useActivity.a'"/>
