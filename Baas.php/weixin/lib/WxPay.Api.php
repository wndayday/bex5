...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 15)
	{
        ...
        Log::DEBUG("unifiedOrder data is valid.");
        ...
        Log::DEBUG("unifiedOrder xml data:".$xml);
        
		$startTimeStamp = self::getMillisecond();//请求开始时间
		$response = self::postXmlCurl($xml, $url, false, $timeOut);
        
        Log::DEBUG("unifiedOrder response data:".$response);
        
		$result = WxPayResults::Init($response);
        
        Log::DEBUG("unifiedOrder result data:".json_encode($result));
