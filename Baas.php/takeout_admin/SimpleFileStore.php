...
class SimpleFileStore 
{
	...
	public static function service($params, $context) 
    {
        ...
        //echo exec('whoami');
        self::$docStorePath = str_replace("model".self::$osSeparator."Baas.php","", APP_ROOT)."model".self::$osSeparator."UI2".self::$osSeparator."demo".self::$osSeparator."takeoutAdmin".self::$osSeparator."data".self::$osSeparator."attachmentSimple";
