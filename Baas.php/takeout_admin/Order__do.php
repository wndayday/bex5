...
require_once(APP_ROOT.'/takeout_admin/Statistics.php');
...
class Order__do {
    ...
    public static function queryTakeout_order($paramsObject, $context){
        ...
        $privateParamBytes =  array(123,34,100,98,34,58,34,100,101,109,111,34,44,34,116,97,98,108,101,78,97,109,101,34,58,34,116,97,107,101,111,117,116,95,111,114,100,101,114,34,125);
    ...
    public static function saveTakeout_order($paramsObject, $context){
        $selfContext = null == $context;
        if ($selfContext)
        {
            $context = new ActionContext(self::DbConfig());
        ...
        $privateParamBytes =  array(123,34,100,98,34,58,34,100,101,109,111,34,44,34,112,101,114,109,105,115,115,105,111,110,115,34,58,123,34,116,97,107,101,111,117,116,95,111,114,100,101,114,34,58,34,34,125,125);
        $privateParams = self::ByteArrayToJson($privateParamBytes);
        $publicParamBytes = array(123,125);
        $publicParams = self::ByteArrayToJson($publicParamBytes);
    ...
    public static function getCuisineStatistics($paramsObject, $context){
        $selfContext = null == $context;
        if ($selfContext)
        {
            $context = new ActionContext(self::DbConfig());
        ...
        try
        {		
            $ret = takeout_admin\Statistics::getCuisineStatistics($paramsObject, $context);
            if ($selfContext)
            {
                $context->commit();
            }
