...
class Dx__do {
    ...
    public static function DuanXinCheck($paramsObject, $context){
        ...
        try
        {		
            $ret = justep\Dx::DuanXinCheck($paramsObject, $context);
            if ($selfContext)
            {
                $context->commit();
            }
    ...
    public static function login($paramsObject, $context){
        $selfContext = null == $context;
        if ($selfContext)
        {
            $context = new ActionContext(self::DbConfig());
        ...
        try
        {		
            $ret = justep\Dx::login($paramsObject, $context);
            if ($selfContext)
            {
                $context->commit();
            }
